...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        repoAddress.saveAll(Arrays.asList(e1, e2));
        ...
        LineItem ip1 = new LineItem(ped1, p1, 0.00, 1, 2000.00);
        LineItem ip2 = new LineItem(ped1, p3, 0.00, 2, 80.00);
        LineItem ip3 = new LineItem(ped2, p2, 100.00, 1, 800.00);
        ...
        repoLItem.saveAll(Arrays.asList(ip1, ip2, ip3));
    }
